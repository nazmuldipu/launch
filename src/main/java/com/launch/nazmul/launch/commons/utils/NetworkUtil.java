package com.launch.nazmul.launch.commons.utils;
...
//        InputStream is = e.getContent();
    ...
    public static boolean sendSms(String phoneNumber, String message) {
        ...
        String url = "http://brandsms.mimsms.com/smsapi?api_key=C20006385a2b8b3bed5180.32394944&type=text&contacts=" + phone +
                "&senderid=8804445629106&msg=" + message;
        try {
